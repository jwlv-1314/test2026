...
**测试：**
- 需要一台运行 **TOS 7.0（当前稳定版/测试版）** 的 TNAS 设备进行本地验证，后续 TOS7.x 小版本预计保持兼容性，建议在正式提交前在目标版本上进行回归测试。
...
4. **远程体验机测试**：开发者若无硬件设备，可申请铁威马官方提供的 TOS7.0 远程体验机，在官方论坛获取体验机的登录信息，无需自备硬件即可完成完整测试。具体申请方式请关注 TNAS 开发者平台公告或官方论坛置顶帖。

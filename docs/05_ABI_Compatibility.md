...
1. **System Library ABI**: Minor version updates will not break glibc ABI. Applications compiled against glibc 2.35 will continue to work normally.
...
← [Previous Chapter: Package Specification](04_Package_Specification.md) &nbsp;&nbsp;|&nbsp;&nbsp; [Next Chapter: Development Environment](06_Development_Environment.md) → &nbsp;&nbsp;|&nbsp;&nbsp; [📖 Return to Contents](../README.md)
